    ...
    <div className='flex flex-col xl:flex-row flex-1 gap-4 p-4'>
        ...
        <div className='flex flex-col lg:flex-row gap-4'>
            ...
            <div className='flex flex-1 gap-4 bg-lamaSky px-6 py-4 rounded-md'>
                <div className='w-1/3'>
                <Image src='/students.jpg' alt='teacher' width={144} height={144} className='w-36 h-36 rounded-full object-cover' />
                </div>
                <div className='w-2/3 flex flex-col justify-between gap-4'>
                <h3 className='text-xl font-semibold'>Cameron Moran</h3>
